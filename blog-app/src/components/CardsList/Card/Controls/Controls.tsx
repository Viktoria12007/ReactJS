...
export default function Controls({data}): React.JSX.Element {
	return (
		<div className={style.controls}>
			<div className={style.karmaCounter}>
				...
				<span className={style.karmaValue}>{data.score}</span>
			...
			<button className={style.commentsButton}>
				...
				<span className={style.commentsNumber}>{data.num_comments}</span>
			</button>
